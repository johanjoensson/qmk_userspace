...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT(
                        ...
                        KC_Z   , KC_X   , KC_C   , HOME_V , KC_B,                                               KC_N   , HOME_M , KC_COMM, KC_DOT , KC_SLSH,
                                                            LSFT_SPC,XXXXXXX, TD(TD_NUM),                   TD(TD_SYM), LSFT_ENT
                       ),
	[_COLEMAK_DH] = LAYOUT(
	...
	[_UCIS] = LAYOUT(
                        ...
                        KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                           KC_N   , KC_M   , XXXXXXX, XXXXXXX, UC_PREV,
                                                   KC_SPC, XXXXXXX , MO(_NUMPAD),              XXXXXXX, KC_ENT
                       ),
        /*
	...
	[_SYMBOLS] = LAYOUT(
                        ...
                        CC_GAMM, CC_SIGM, CC_RHO , CC_SNEK, TD_PIPE,                             KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_TILD,
                                                            CC_SHLD, XXXXXXX, MO(_NAV),     TG(_SYMBOLS), KC_RSFT
                        ),
        /*
	...
	[_NUMPAD] = LAYOUT(
                DF(_COLEMAK_DH), UG_SATU, UG_HUEU, UG_VALU, UG_NEXT,                                 KC_ASTR, KC_7   , KC_8   , KC_9   , KC_MINS,
                      ...
                      DF(_BASE), XXXXXXX, DT_UP  , DT_DOWN, DT_PRNT,                                 KC_COMM, KC_1   , KC_2   , KC_3   , KC_DOT,
                                                            _______, XXXXXXX, TG(_NUMPAD),          MO(_NAV), RSFT_T(KC_0)
                        ),
        /*
	...
	[_NAV] = LAYOUT(
                        ...
                        KC_KB_MUTE       , KC_F1  , KC_F2  , KC_F3  , KC_F12 ,                              KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX,
                                                                      XXXXXXX, XXXXXXX, TG(_NAV),          TG(_NAV), XXXXXXX
                        ),
        [_MOUSE] = LAYOUT(
                        ...
                        XXXXXXX, MS_BTN2, MS_WHLU, MS_WHLD, _______,                                           MS_BTN1,       MS_ACL0,              MS_ACL1,            MS_ACL2,       XXXXXXX,
                                                            TO(_NUMPAD), XXXXXXX, TG(_MOUSE),       TG(_MOUSE), TO(_SYMBOLS)
                        ),
};
