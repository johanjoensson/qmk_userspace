...
#define CDH_HOME_R LALT_T(KC_R)   /*COLEMAK-DH*/
#define HOME_F LCTL_T(KC_F)       /*QWERTY*/
#define HOME_V LGUI_T(KC_V)       /*QWERTY*/
#define CDH_HOME_T LCTL_T(KC_T)   /*COLEMAK-DH*/
#define CDH_HOME_D LGUI_T(KC_T)   /*COLEMAK-DH*/
#define HOME_J LCTL_T(KC_J)       /*QWERTY*/
#define HOME_M LGUI_T(KC_M)       /*QWERTY*/
#define CDH_HOME_N LCTL_T(KC_N)   /*COLEMAK-DH*/
#define CDH_HOME_H LGUI_T(KC_N)   /*COLEMAK-DH*/
